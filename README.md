🧠 Web Alat Ukur Psikologi – Auto Result Scoring Proyek ini adalah web sederhana berbasis Flask untuk mengukur aspek psikologi pengguna dengan mengisi kuisioner. Setelah user mengisi data diri dan menjawab semua pertanyaan, sistem otomatis menghitung total skor dan menampilkan kategori hasil berdasarkan metode Mean Hipotetik dan Standar Deviasi.
...
🚀 Cara Menjalankan
Clone repo ini
Import struktur database dari db.sql (jika ada)
Pastikan MySQL aktif dan database='alat_ukur' tersedia
Install dependency Flask pip install flask mysql-connector-python
